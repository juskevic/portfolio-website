...
const Socials = () => {
    return (
        <>
            <div>
                <div className="flex flex-row justify-center p-4 w-full space-x-8 text-2xl bottom-0 sticky opacity-90 animate-fade-up animate-once animate-delay-200 animate-ease-out">
